...
CREATE TABLE XFL_TASK_DEF(
  id VARCHAR(50) NOT NULL ,
  proc_def_id VARCHAR(50) NOT NULL ,
  name VARCHAR(255) NOT NULL ,
...
CREATE TABLE XFL_FLOW_DEF(
  ...
  source_tdef_id VARCHAR(50) NOT NULL ,
  target_tdef_id VARCHAR(50) NOT NULL ,
...
CREATE TABLE XFL_TASK_INST(
  id VARCHAR(50) NOT NULL ,
  proc_inst_id VARCHAR(50) NOT NULL ,
  task_def_id VARCHAR(50) NOT NULL ,
