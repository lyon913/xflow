...
import com.xqx.xflow.core.impl.persistence.querydsl.QXflFlowInst;
import com.xqx.xflow.core.impl.persistence.querydsl.QXflTaskInst;

/**
 * Created by Lyon on 2017/2/14.
 */
public class FlowInstDao extends AbstractDao<QXflFlowInst, XflFlowInst, String> {

    public FlowInstDao(SQLQueryFactory queryFactory, IdGenerator idGenerator) {
